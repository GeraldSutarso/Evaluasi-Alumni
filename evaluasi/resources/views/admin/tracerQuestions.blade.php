...
<div class="container mx-auto px-4 py-8">
    ...
    <h1 class="text-2xl font-bold mb-6">Modifikasi Survey Tracer Study Alumni</h1>
...
<div id="editQuestionModal" class="fixed inset-0 flex items-center justify-center bg-gray-500 bg-opacity-50 hidden">
    <div class="bg-white p-6 rounded-lg shadow-lg w-96">
        ...
        <form id="editQuestionFormModal">
            ...
            <div class="mb-4">
                <label for="editTextModal" class="block text-gray-700">Teks Pertanyaan</label>
                <input type="text" id="editTextModal" name="text" class="w-full p-2 border border-gray-300 rounded-md" required>
            </div>
            <div class="mb-4">
                <label for="editTypeModal" class="block text-gray-700">Type Pertanyaan</label>
...
document.getElementById('addOptionFormModal').addEventListener('submit', function(e) {
    ...
    fetch(`/admin/tracer-study/questions/${questionId}/options`, {
        method: 'POST',
        headers: {
...
document.getElementById('editOptionFormModal').addEventListener('submit', function(e) {
    ...
    fetch(`/admin/tracer-study/options/${optionId}`, {  // Make sure the URL is correct (including prefix if needed)
...
document.addEventListener('click', function(e) {
    ...
    if (deleteBtn) {
        ...
        if (confirm('Are you sure you want to delete this option?')) {
            fetch(`/admin/tracer-study/options/${optionId}`, {
                method: 'DELETE',
                headers: { 'X-CSRF-TOKEN': '{{ csrf_token() }}' }
            })
            .then(response => response.json())
